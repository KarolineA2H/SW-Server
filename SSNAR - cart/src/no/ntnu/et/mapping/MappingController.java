...
public class MappingController extends Thread {
    ...
    public void addRobot(String name) {
        ...
        System.out.println("System has set initial pos X: " + initialPosition[0]+ "Y: " + initialPosition[1]);
        ...
        while (true) {
            ...
            if (paused) {
             ...
             for (int i = 0; i < robotNames.size(); i++) {
                ...
                //System.out.println("Mapping controller has set robot pose X: " + position[0] + "Y: " + position[1]);
