...
public class InboxReader extends Thread {
                ...
                try {
                    switch (message.getType()) {
                        ...
                        case Message.UPDATE:
                            ...
                            //robot.setIRMeasurement(irData); 
                            doUpdateIR(address,irData);
                            break;
                        ...
                        case Message.DEBUG:                       
                            ...
                            //}
                            //String msg = String.valueOf(message.getData());
                            ...
                            String msg = String.valueOf(asFloat); //comment inn this and line 131) it you want to have the gyromeasurment from the robot
                            //String raw = String.valueOf(bytes);
                            
                            //System.out.println("DEBUGG message:"); 
                            //System.out.println(msg); //comment inn this and line 127) it you want to have the gyromeasurment from the robot
                            ...
                            //int asint = Float.intBitsToFloat(asInt);
                            
                            //String msg2 = String.valueOf(asInt); //comment inn this and line 131) it you want to have the gyromeasurment from the robot
    ...
    private void doUpdateIR(int address,int[] irData){
        rc.addIRMeasurement(address,irData); 
    }
    /**
     * Method for updating one of the robots in the system
     *
