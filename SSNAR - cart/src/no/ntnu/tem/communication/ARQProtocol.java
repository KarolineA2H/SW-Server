...
public class ARQProtocol implements Protocol {
    ...
    private static final int RETRANSMISSION_TIMEOUT = 200;//Edid from 200 to se if the timeout will not hapen so often 
    private static final int LOST_CONNECTION_TIMEOUT = 1000; //Edid from 1000 to se if the timeout will not hapen so often 
