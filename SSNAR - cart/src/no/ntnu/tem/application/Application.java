...
public final class Application {
    ...
    public final Communication com;
    ...
    public void connectToRobot(Robot r) {
        if (!simulatorActive) {
            ...
            System.out.println("Er i robbot applikasjonen");
     ...
     * @param y the y-coordinate
     */
    public void writeCommandToRobotWithRot(int robotID, String robotName, int x, int y, int angle) {
        //  newTime[robotID] = System.currentTimeMillis();
        if (!simulatorActive) {
            if (debug) {
                System.out.println("debug: writeCommandToRobot() entered: " + x + "," + y);
            }
            com.sendOrderToRobotWithRot( rc.getRobot(robotID).getAddress(), x, y, angle);
            //sendOrderCOM(robotID, robotName, x, y, angle);
            System.out.println("writeCommandToRobot() entered: " + x + "," + y +", "+ angle);
        } else {
            sim.setRobotCommand(robotName, x, y);
        }
        rc.getRobot(robotName).setBusy(true);
    ...
    public void sendOrderCOM(int adress, String robotName, int x, int y, int angle){
        this.com.sendOrderToRobotWithRot(adress, x, y, angle);
    }
