...
public class Robot {
    ...
    public Robot(int robotID, int address, String name, int width, int length, int messageDeadline,
        ...
        this.basePosition = new int[]{0, 0, 0};
    ...
    public void addIRMeasurement(int[] irData){
        //this.distData = irData; 
    }
    /* Resive IR measurement from message and set them in inbox */
    public void setIRMeasurement(int[] irData){
        this.distData = irData; 
    }

    public int[] getIRMeasurement(){
